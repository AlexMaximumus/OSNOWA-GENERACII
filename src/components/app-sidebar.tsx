...
import { Film, MountainSnow, Users, UserPlus, Shirt, Library, Map } from 'lucide-react';
import {
  SidebarHeader,
  SidebarMenu,
  SidebarMenuItem,
...
const mainLinks = [
  ...
  { href: '/location-creation', label: 'Create Location', icon: Map },
...
const libraryLinks = [
  ...
  { href: '/location-library', label: 'Location Library', icon: Library },
