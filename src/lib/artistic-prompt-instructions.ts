...
Ты должен строго следовать этому шаблону для создания промпта. Заполняй разделы в квадратных скобках на основе предоставленного описания.
...
Шаблон:
A soft film photo taken on a {camera} with a {filmType}, 
